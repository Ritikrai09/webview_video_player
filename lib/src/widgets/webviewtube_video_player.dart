...
class WebviewtubeVideoPlayer extends StatelessWidget {
  ...
  WebviewtubeVideoPlayer({super.key, required this.videoId, WebviewtubeController? controller})
  ...
  Widget build(BuildContext context) {
    ...
    return controller != null
        ...
        : ChangeNotifierProvider<WebviewtubeController>(
            create: (_) => WebviewtubeController(options: const WebviewtubeOptions(showControls: false)),
            child: _child,
          );
  }
}
